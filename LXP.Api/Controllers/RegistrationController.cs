...
namespace LXP.Api.Controllers
{
    ...
    public class RegistrationController : BaseController
    {
        ...
        [HttpPut("/lxp/learner/updateProfile/{id}")]
        public async Task<IActionResult> UpdateProfile(string id, [FromForm] UpdateProfileViewModel model, IFormFile file)
        {
            //string filePath = null;

            //if (file != null)
            //{
            //    filePath = Path.Combine("D:\\Priya Backend one\\LXP.Api\\wwwroot\\Images\\", file.FileName);
